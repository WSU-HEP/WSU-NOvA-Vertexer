...
#SBATCH --mem=450000M      # RealMemory=514903M for gpu202401
...
###SBATCH --mail-user \${USER}\@wichita.edu
#======================================================================================================================================
...
#Variable settings
PK_SITE_PACKAGES="/homes/m962g264/virtual-envs/py3113_gcc1230_clean/lib/python3.11/site-packages"
MODEL_SITE_PACKAGES="/homes/b677h798/MikeDolce_Research_Data/virtual-envs/py3.11-pipTF2.15.0/lib/python3.11/site-packages"
PK_BASE_LIB="/homes/m962g264/pykokkos/base/install/lib64"

source /homes/b677h798/MikeDolce_Research_Data/virtual-envs/py3.11-pipTF2.15.0/bin/activate


# IMPORTANT: Model Site-Packages MUST come first to satisfy TensorFlow's NumPy version.              
# PyKokkos comes second, and your source code (WSUVTX) comes third.

echo "INFO: appending WSUVTX to PYTHONPATH"
unset PYTHONPATH
export PYTHONPATH="${MODEL_SITE_PACKAGES}:${PK_SITE_PACKAGES}:${WSUVTX}"
echo "PYTHONPATH is ... \$PYTHONPATH"

export LD_LIBRARY_PATH="${PK_BASE_LIB}:/homes/b677h798/MikeDolce_Research_Data/virtual-envs/py3.11-pipTF2.15.0/lib:${LD_LIBRARY_PATH}:"
...
python3 -c "import numpy; print(f'Using NumPy: {numpy.__version__} from {numpy.__file__}')"
python3 -c "import pykokkos as pk; print(f'PyKokkos detected: {pk.get_default_space()}')"
echo "----------------------------------------------------------------"
